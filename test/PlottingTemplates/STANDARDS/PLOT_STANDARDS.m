function PS = PLOT_STANDARDS()
    ...
    PS.TitleFontSize = 24;
    PS.LegendFontSize = 16;
    PS.AxisFontSize = 20;
    PS.PlotTextFontSize = 16;
    PS.AxisNumbersFontSize = 14;
    
    
    % Tiled Properties
    PS.Tiled.Global.TitleFontSize = 26;
    PS.Tiled.Global.AxisFontSize = 22;
    
    PS.Tiled.SubPlot.TitleFontSize = 22;
    PS.Tiled.SubPlot.LegendFontSize = 14;
    PS.Tiled.SubPlot.AxisFontSize = 18;
    PS.Tiled.SubPlot.PlotTextFontSize = 14;
    PS.Tiled.SubPlot.AxisNumbersFontSize = 12;
