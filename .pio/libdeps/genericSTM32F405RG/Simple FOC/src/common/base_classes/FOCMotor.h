...
class FOCMotor
{
  public:
     ...
     * Function linking a motor and a sensor used for retrieve the speed 
     * 
     * @param sensor_v Sensor class  wrapper for the FOC algorihtm to read the motor angle and velocity
     */
    void linkVelSensor(Sensor* sensor_v);

    /** Custom feature IAS lab LB - march 2022
     * Function linking a motor and a sensor used for retrieve the position
     * 
     * @param sensor_p Sensor class  wrapper for the FOC algorihtm to read the motor angle and velocity
     */
    void linkPosSensor(Sensor* sensor_p);
