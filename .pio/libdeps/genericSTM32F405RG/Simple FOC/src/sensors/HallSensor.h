...
class HallSensor: public Sensor{
 public:
  ...
  //private:
    ...
    volatile float Ts;  
    volatile float vel_cal = 0;
    volatile float vel_cal_old = 0;

    volatile int vel_cal_dis_tr = 20; 
    volatile int vel_cal_dis_nu = 5;
    volatile int vel_cal_dis_av = vel_cal_dis_nu;
